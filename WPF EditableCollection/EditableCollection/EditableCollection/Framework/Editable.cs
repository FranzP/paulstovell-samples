...
namespace BindingOriented.Adapters
{
    ...
    /// </summary>
    /// <typeparam name="TWrappedObject">The type of the wrapped object.</typeparam>
        ...
        where TWrappedObject : class, new()
    {
        ...
        /// </summary>
        public TWrappedObject Original
        {
            get { return _current; }
        }
        ...
        {
            get { return _changedProperties.Count > 0 || IsDeleted || IsNew; }
        }
